...
async def enhance_resume(resume_id: int, job_description: str, db: Session) -> None:
    ...
    prompt = f"""
    You are an expert resume writer and career coach. Your task is to enhance the following resume to better match the job description.
    ...
    2. Improving bullet points to be more impactful and achievement-focused
    3. Reorganizing content to highlight relevant experience
    4. Maintaining a professional tone
    5. Keeping the original structure and format
